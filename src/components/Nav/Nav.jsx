  ...
  return (
    <nav className={isOpen ? 'show' : 'close'} >
      <div className='lang-btns-container'>
        <button className={active === false ? "active" : ""} onClick={() => changeLanguage('en')}>EN</button>
        <button className={active === true ? "active" : ""} onClick={() => changeLanguage('es')}>ES</button>
      </div>
      <div className='links-container'>
        <a href='#services'>{i18n.t('nav.link2')}</a>
        <a href='#projects'>{i18n.t('nav.link3')}</a>
